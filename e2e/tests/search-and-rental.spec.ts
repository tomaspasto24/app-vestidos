...
//     const itemLink = itemCount > 1 ? itemLinks.nth(itemCount - 1) : itemLinks.first();
...
//     const isFormVisible = await itemPage.isRentalFormVisible();
...
//     await page.waitForSelector(itemPage.nameInput, { state: "visible" });
//     await page.waitForSelector(itemPage.submitButton, { state: "visible" });
